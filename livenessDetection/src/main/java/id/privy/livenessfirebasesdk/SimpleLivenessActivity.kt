...
class SimpleLivenessActivity : AppCompatActivity() {
    ...
    private val previewSize : Size by lazy { cameraSource!!.previewSize }
    ...
    private fun createCameraSource() {
        ...
        val motion = Motion.values()[java.util.Random().nextInt(Motion.values().size)]
    ...
    private fun startCameraSource() {
        if (cameraSource != null) {
            try {
                ...
                Toast.makeText(this, "overlay size " + previewSize, Toast.LENGTH_SHORT).show()
            } catch (e: IOException) {
